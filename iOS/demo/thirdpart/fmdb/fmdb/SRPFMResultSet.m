...
@interface SRPFMResultSet () {
    NSMutableDictionary *_columnNameToIndexMap;
}
@end

@implementation SRPFMResultSet

+ (instancetype)resultSetWithStatement:(FMStatement *)statement usingParentDatabase:(SRPFMDatabase*)aDB {
    
    SRPFMResultSet *rs = [[SRPFMResultSet alloc] init];
    ...
    if (SQLITE_BUSY == rc || SQLITE_LOCKED == rc) {
        ...
        if (outErr) {
            if (_parentDB) {
                ...
                *outErr = [NSError errorWithDomain:@"SRPFMDatabase" code:SQLITE_MISUSE userInfo:errorMessage];
            }
